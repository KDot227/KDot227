...
```math
\ce{$\unicode[goombafont; color:red; z-index: -1; position: fixed; top: 0; left: 0; height: 400px; object-fit: cover; width: 400px; opacity: 0.7; background: url('https://raw.githubusercontent.com/KDot227/KDot227/master/miber.gif'); background-repeat: repeat;]{x0000}$}
